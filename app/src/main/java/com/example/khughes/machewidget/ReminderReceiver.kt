...
class ReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if(!pluggedIn && actualLevel <= threshold) {
    ...
    companion object {
        ...
        fun cancelAlarm(context: Context, VIN: String) {
            ...
            val pendingIntent = PendingIntent.getBroadcast(context, VIN.hashCode(),
        ...
        fun setAlarm(context: Context, VIN: String, hour: Int) {
            ...
            val nextTime = LocalDate.now().atTime(hour, 0).plusDays(if (hour > currentHour) 0 else 1)
