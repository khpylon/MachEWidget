...
public class Notifications extends BroadcastReceiver {
    ...
    private static final int SURVEY_STATUS = 942;

    public static void surveyPrompt(Context context) {
        ...
        if (currentSurveyVersion < Constants.SURVEY_VERSION) {
            PreferenceManager.getDefaultSharedPreferences(context).edit().putInt(surveyVersion_key, Constants.SURVEY_VERSION).apply();
