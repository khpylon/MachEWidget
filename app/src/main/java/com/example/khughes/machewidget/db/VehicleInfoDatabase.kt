...
abstract class VehicleInfoDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_10_11: Migration = object : Migration(10,11) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL(
                    "ALTER TABLE vehicle_info ADD COLUMN car_xevBatteryEnergyRemaining REAL DEFAULT 0 NOT NULL"
                )
                database.execSQL(
                    "ALTER TABLE vehicle_info ADD COLUMN car_pluginTime TEXT DEFAULT '' NOT NULL"
                )
            }
        }
        ...
        private val MIGRATION_11_12: Migration = object : Migration(11,12) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL(
                    "ALTER TABLE vehicle_info ADD COLUMN car_ambientTemp REAL DEFAULT 0 NOT NULL"
                )
            }
        }
        ...
        private val MIGRATION_12_13: Migration = object : Migration(12,13) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL(
                    "ALTER TABLE vehicle_info ADD COLUMN car_xevBatteryTemperature REAL DEFAULT 0 NOT NULL"
                )
                database.execSQL(
